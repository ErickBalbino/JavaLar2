...
public class PHP extends Planeta {
	private static final String NOME = "PHP";
	private static final int VELOCIDADE_TRANS = 2;
	private static final int VELOCIDADE_ROT = 60;
	private static final int ORBITA = 9;

	private int diasPassados;
	private int anosPassados;

	public PHP(int posX, int posY) {
		super(NOME, posX, posY, VELOCIDADE_TRANS, VELOCIDADE_ROT, 60, 0, 0);
		this.diasPassados = 0;
		this.anosPassados = 0;
	}
